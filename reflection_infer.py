...
adapter_path    = "identification-final"
...
def get_reflection_reply(user_message: str, length: int=512) -> str:
    global _model
    """
    ...
    messages = [
        {"role": "system", "content": """당신은 반영(Reflection) 상담사'입니다.\n        목표: 내담자의 감정, 생각, 경험을 요약하거나 되짚어주는 대화를 진행합니다.\n        규칙:\n        1) 질문 허용. \n        2) 존댓말 유지.\n        3) 내담자의 감정, 생각, 경험에 대해 질문하기.\n        """},
